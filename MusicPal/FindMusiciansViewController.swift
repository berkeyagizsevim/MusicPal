...
class FindMusiciansViewController: UIViewController {
    ...
    func createData(){
        ...
        let rnbMusician1 =  MusicianData(name: "Kaan Tangöze", image: "profile-pic", needs: "looking for a pianist for playing a Rock ", location: "Bursa - Turkey", description: "Hello, my name is Kaan from Turkey! 🇹🇷 I love playing guitar. Mostly i like playing Jazz. We if you are interested in Jazz around Besiktas, text me or hire me!", details: ["5 year experience on music industry. Freelance song writer.","playing guitar for 10 years. Best solo guitarist in this town. He loves Michael Jordan.","he is looking for piano artist from Istanbul. Also wants to play in public transportation.","he loves Jazz, RnB, HipHop music. "])
        let rnbMusician2 =  MusicianData(name: "Gökhan Taşdeğmez", image: "profile-pic", needs: "looking for a solist for playing a Rock ", location: "İzmir - Turkey", description: "Hello, my name is Kaan from Turkey! 🇹🇷 I love playing guitar. Mostly i like playing Jazz. We if you are interested in Jazz around Besiktas, text me or hire me!", details: ["5 year experience on music industry. Freelance song writer.","playing guitar for 10 years. Best solo guitarist in this town. He loves Michael Jordan.","he is looking for piano artist from Istanbul. Also wants to play in public transportation.","he loves Jazz, RnB, HipHop music. "])
